...
class ConstansStyle {
  static const TextStyle men = TextStyle(
    fontSize: 18,
    fontFamily: 'Roboto',
  ...
  static const TextStyle blueGrey25 = TextStyle(
    fontSize: 20,
    color: ConstansColor.blueGrey,
    fontFamily: "Roboto",
  );
  static const TextStyle grey25 = TextStyle(
    fontFamily: "Roboto",
    fontSize: 25,
    color: ConstansColor.grey,
  );
  static const TextStyle purple20blod = TextStyle(
    fontSize: 20,
  ...
  static const TextStyle yellow20W600 = TextStyle(
    fontFamily: "Roboto",
    fontSize: 20,
  ...
  static const TextStyle fo50 = TextStyle(
    fontFamily: "Roboto",
    fontSize: 50,
  );
  static const TextStyle black15w600 = TextStyle(
    color: ConstansColor.black,
    fontFamily: "Roboto",
    fontSize: 15,
